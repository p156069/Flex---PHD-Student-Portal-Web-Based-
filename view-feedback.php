   ...
   <body class=" theme-blue">
      ...
      <div class="content">
         ...
         <div class="main-content">
            <?php
               $xml = simplexml_load_file("gcs-feedback.xml");
               
               foreach($xml->student as $item){
                  if(similar_text($item->attributes(), $_SESSION['username'])){
                 ...
                 echo "
                       ...
                       <thead>
                          ...
                          <th ><center>Professor Email<center></th>
                          <th colspan='10'><center>Feedback<center></th>
                       </thead>
                       <tbody>
                       <tr>
                          <td><center>";?><?php echo $item->tname;?><?php echo"<center></td>
               <td><center>";?><?php echo $item->temail;?><?php echo"<center></td>
               <td ><center><textarea rows='2' cols='100'> ";?><?php echo $item->message;?><?php echo"</textarea></center></td>
               </tr>
