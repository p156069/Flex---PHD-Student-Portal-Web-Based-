   ...
   <body class=" theme-blue">
      ...
      <div class="row">
         <div class="col-sm-6 col-md-6">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-lg-4">
                     <div class="box">
                        <div class="icon">
                           ...
                           <div class="info">
                              <h3 class="title">Enter you details</h3>
                              <p>
                                 Enter all of your necessary details which are required by the  univeristy need to be entered, so update your profile with accurate details.
                              </p>
                              <div class="more">
                                 <a href="registeration" title="Click Here">
                  ...
                  <div class="col-xs-12 col-sm-6 col-lg-4">
                     <div class="box">
                        <div class="icon">
                           ...
                           <div class="info">
                              <h3 class="title">View Feedback</h3>
                              <p>
                                 You can view your feedback regarding synopsis &  thesis documents in this section. To view click on view feedback
                              </p>
                              <div class="more">
                                 <a href="view-feedback.php" title="View feedback">
                                 View feedback <i class="fa fa-angle-double-right"></i>
                                 </a>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-xs-12 col-sm-6 col-lg-4">
                     <div class="box">
                        <div class="icon">
                           <div class="image"><i class="fa fa-cloud-upload	"></i></div>
                           <div class="info">
                              <h3 class="title">Upload Synopsis and thesis documents</h3>
                              <p>
                                 Here you can upload your synopsis and thesis documents. To upload your documents click on upload documents
                              </p>
                              <div class="more">
                                 <a href="registeration/synopsis-thesis.html" title="Upload Documents">
                                 Upload Documents <i class="fa fa-angle-double-right"></i>
                                 </a>
                              </div>
                           </div>
                        </div>
            ...
            <footer>
               <hr>
               <p class="pull-right">A <a href="http://local.com/" target="_blank">PHD Student NEON</a> by <a href="http://pwr.nu.edu.pk" target="_blank">PESHAWAR</a></p>
